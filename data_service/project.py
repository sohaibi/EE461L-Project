...
def handle_update_hardware(project_id:str, HWSet_id:str, changedNumber:int):
    ...
    collection.update_one({"_id": ObjectId(project_id)}, {"$set": {"hardware_set_dict": hardware_set_dict, "last_edited": generate_date()}})
...
handle_update_project("6068e2b60256e4eac9139bff", "Yue 1st change", "1st change")
