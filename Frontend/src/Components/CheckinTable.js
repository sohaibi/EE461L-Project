...
//comment out for testing
    useEffect(() => {
        ...
        let list = [];
        //let list = [{HW_changeNum: 3, HW_id: "1", HW_name: "hello"},{HW_changeNum: 3, HW_id: "2", HW_name: "world"}]; //for dunmmy data test case!!
        ...
        setCheckinList(list);
        props.handleList(list); //added function for testing
                ...
                return (
                    <>
                        ...
                        <tr key={index.toString()}>
                            ...
                            <td data-testid='hw_name' >{hw.HW_name}</td>
                            <td>
                                <input
                                    data-testid='inArrow'
                                    type="number"
